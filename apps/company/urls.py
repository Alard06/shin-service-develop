...
from .views import company_list, create_company, company_detail, add_suppliers_to_company, delete_supplier_company, \
    ...
    result_uniq, download_file, result_processing, output_table_company, output_table_company_formated
...
urlpatterns = [
    ...
    path('company/<int:company_id>/result-processing/<int:processing_id>', result_processing, name='result_processing'),
    path('download/<int:uniq_data_id>/', download_file, name='download_file'),
    path('company/<int:company_id>/output-table/', output_table_company, name='output_table_company'),
    path('company/<int:company_id>/output-table/formated/', output_table_company_formated, name='output_table_company_formated')
